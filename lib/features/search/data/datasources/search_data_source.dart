...
import 'package:scene/core/errors/remote/search_error_handler.dart';
...
class SearchDataSource {
  ...
  Future<CommonResponseModel> searchMovies(String query) async {
    try {
      ...
      if (e is DioException) {
        ...
        throw SearchErrorHandler(message: message);
      }
