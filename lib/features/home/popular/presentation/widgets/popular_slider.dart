...
import 'package:scene/features/home/popular/presentation/cubit/popular_state.dart';
import 'package:scene/features/home/popular/presentation/widgets/slider_item.dart';
...
class _PopularSliderState extends State<PopularSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<PopularCubit, PopularState>(
      bloc: BlocProvider.of<PopularCubit>(context),
      ...
      builder: (context, state) {
        if (state is PopularLoadingState) {
          ...
          posters =
              BlocProvider.of<PopularCubit>(context).posters!.movies ?? [];
          return SizedBox(
            height: 289.h,
