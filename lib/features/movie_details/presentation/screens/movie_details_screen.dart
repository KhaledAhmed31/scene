...
import 'package:scene/features/home/movies_sections/presentation/more_like_this_section.dart';
...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<MovieDetailsCubit>(
      context,
    ).fetchMovieDetails(widget.movieId.toString());
