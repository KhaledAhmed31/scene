        ...
        children: [
          ...
          Positioned(
            child: GestureDetector(
              onTap: () {
                setState(() {
                  BlocProvider.of<WatchlistCubit>(context).addToWatchlist(CommonItemEntity(id: widget.movieCardEntity.id, title: widget.movieCardEntity.title, releaseDate: widget.movieCardEntity.releaseDate, backdropPath: widget.movieCardEntity.backdropPath,));
